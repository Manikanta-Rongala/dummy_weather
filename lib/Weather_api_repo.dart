...
import 'package:http/http.dart' as http;
  ...
  class WeatherApiRepository {
    ...
    Future<WeatherModel> getForecast() async{
      ...
      var response = await http.get(Uri.parse("https://api.openweathermap.org/data/2.5/forecast?q=visakhapatnam&appid=bb26f715f920ad6b3e6674d623cc555e&units=metric"));
